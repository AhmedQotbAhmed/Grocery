...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private TextView recipients_out;
    private TextView address__checkout;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        list= (HashMap<String, Products>) intent.getSerializableExtra("inv");
                ...
                recipients_out=findViewById(R.id.recipients__checkout);
        address__checkout=findViewById(R.id.delivery_address__checkout);
        recipients_out.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(CheckoutActivity.this, RecipientsActivity.class));

            }
        });
        address__checkout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
